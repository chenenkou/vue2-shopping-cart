          ...
          <div class="detail col-md-6 col-sm-6">
            ...
            <div class="options">
              ...
              <dl class="option dl-horizontal">
                ...
                <dd>
                  <ul>
                    <li v-for="(styleUrl, key) in iPhone6S.style" @click="changeStyle({styleName: key, styleUrl: styleUrl})" :class="{active: iPhone6S.activeStyleUrl == styleUrl}">
